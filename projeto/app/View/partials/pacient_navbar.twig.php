                ...
                <div class="collapse navbar-collapse pt-2" id="navbarColor01">
                    <ul class="navbar-nav mr-auto">
                        <li {% if page == 'home' %} class="nav-item active" {% else %} class="nav-item" {% endif %}>
                            <a class="nav-link" href="/paciente/home">Home <span class="sr-only">(current)</span></a>
                        </li>
                        <li {% if page == 'exames' %} class="nav-item active" {% else %} class="nav-item" {% endif %}>
                            <a class="nav-link" href="/paciente/exames">Meus Exames</a>
                        </li>
                        <li {% if page == 'cadastro' %} class="nav-item active" {% else %} class="nav-item" {% endif %}>
                            <a class="nav-link" href="/paciente/cadastro">Meu Cadastro</a>
                        </li>
                    </ul>
