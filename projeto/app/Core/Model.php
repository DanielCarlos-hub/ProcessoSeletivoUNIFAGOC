...
abstract class Model
{
    ...
    /** @var array $protected atributos protegidos na tabela */
    protected $protected;

    /** @var array $required atributos obrigatórios na tabela */
    protected $required;
    
    /**
     * Model constructor
     * @param string $entity database table name
     * @param array $protected atributos protegidos na tabela
     * @param array $required atributos obrigatórios na tabela
     */
...
/**
    ...
    {
        return Connection::getInstance()->query("SELECT MAX(id) as maxId FROM {$this->entity}")->fetch()->maxId + 1;
    }
